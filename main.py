...
def scores():
    ...
    while t:
        ...
        if size > 0:
            draw_text(screen, "1) " + str(*list(items[size - 1])[1]) + ": "+str(list(items[size - 1])[0]), 30, W / 2, H / 2 - 50)
        if size > 1:
            draw_text(screen, "2) " + str(*list(items[size - 2])[1]) + ": "+str(list(items[size - 2])[0]), 30, W / 2, H / 2 + 10)
        if size > 2:
            draw_text(screen, "3) " + str(*list(items[size - 3])[1]) + ": "+str(list(items[size - 3])[0]), 30, W / 2, H / 2 + 70)
        if size > 3:
            draw_text(screen, "4) " + str(*list(items[size - 4])[1]) + ": "+str(list(items[size - 4])[0]), 30, W / 2, H / 2 + 130)
        if size > 4:
            draw_text(screen, "5) " + str(*list(items[size - 5])[1]) + ": "+str(list(items[size - 5])[0]), 30, W / 2, H / 2 + 190)

...
def textures():
    ...
    while p:
        ...
        draw_text(screen, "textures", 75, W / 2, 150)
        draw_text(screen, ". .", 80, W / 2, 200)
        draw_text(screen, "_", 80, W / 2, 220)

        draw_text(screen, "<", 40, W / 2 - 100, H / 2 + 10)
        draw_text(screen, ">", 40, W / 2 + 100, H / 2 + 10)
...
def setting():
    ...
    while p:
        ...
        but2 = Button(200, 50)
        but2.draw(screen, W / 2 - 100, H / 2 + 10, "textures", None, textures)
...
def scores():
    ...
    while t:
        ...
        if size > 0:
            draw_text(screen, "1) " + str(*list(items[size - 1])[1]) + ": " + str(list(items[size - 1])[0]), 30, W / 2,
                      H / 2 - 50)
        if size > 1:
            draw_text(screen, "2) " + str(*list(items[size - 2])[1]) + ": " + str(list(items[size - 2])[0]), 30, W / 2,
                      H / 2 + 10)
        if size > 2:
            draw_text(screen, "3) " + str(*list(items[size - 3])[1]) + ": " + str(list(items[size - 3])[0]), 30, W / 2,
                      H / 2 + 70)
        if size > 3:
            draw_text(screen, "4) " + str(*list(items[size - 4])[1]) + ": " + str(list(items[size - 4])[0]), 30, W / 2,
                      H / 2 + 130)
        if size > 4:
            draw_text(screen, "5) " + str(*list(items[size - 5])[1]) + ": " + str(list(items[size - 5])[0]), 30, W / 2,
                      H / 2 + 190)
    ...
    while end_game:
        ...
        while run1:
            ...
            for hit in hits:
                ...
                if hit.Hp <= 0:
                    ...
                    # puk.play()
                    NewBob()
                    if random.randrange(1, 100) > 70 or garant == 100:
        ...
        while run2:
            ...
            for hit in hits:
                ...
                if stage == 2 or stage == 3 or stage == 4 or stage == 5 or stage == 6 or stage == 7 or stage == 8 \
                        or stage == 9 or stage == 10 or stage == 1:
                    for i in range(N):
                        NewBob()
